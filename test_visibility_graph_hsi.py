...
# python -m openne --method hope  --input HSI_Network.txt --graph-format edgelist   --epochs 20 --output Vec_HSI_Network.txt --clf-ratio 0.5   --number-walks 10  --walk-length 80  --window-size 5 --representation-size 10
